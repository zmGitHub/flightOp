(function() {
  ...
  tooltipTemplate = '' + '<div class="tooltip-arrow"></div>' + '<div style="background-color: rgba(0,0,0,0.75);border-radius: 5px;" class="tooltip-inner">' + '{{#if html}}' + '   {{{content}}}' + '{{else}}' + '   {{content}}' + '{{/if}}' + '</div>';
